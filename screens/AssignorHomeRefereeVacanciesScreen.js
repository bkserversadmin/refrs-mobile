...
const AssignorHomeRefereeVacanciesScreen = props => {
        ...
        <View style={StyleSheet.applyWidth({ padding: 16 }, dimensions.width)}>
          ...
          >
            ...
            <Button
              onPress={() => {
                try {
                  navigation.navigate('AssignorHomeCreatedGamesScreen');
                } catch (err) {
                  console.error(err);
                }
              }}
...
export default withTheme(AssignorHomeRefereeVacanciesScreen);
